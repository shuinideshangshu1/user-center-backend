package com.my.usercenter.service.impl;
...
import com.my.usercenter.mapper.UserMapper;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User>
    ...
    @Override
    public boolean baseSetting(HttpServletRequest request, String username, String gender, String phone, String email) {
        ...
        int update = userMapper.update(currentUser, updateWrapper);
        if (update==1){
            return true;
        } else
            return false;
